...
!function(t, e) {
    ...
    var a = function() {
      ...
      , l = function(t) {
        ...
        return i(r, t),
        r.prototype.preprocessInput = function(t) {
            return e.tidy(function() {
    ...
    var c = function() {
        ...
        t.prototype.sink = function(t) {
            for (; 2 * t <= this.numberOfElements; ) {
                var e = 2 * t;
                if (e < this.numberOfElements && this.less(e, e + 1) && e++,
                !this.less(t, e))
                    break;
                this.exchange(t, e),
                t = e
    ...
    var h = ["nose", "leftEye", "rightEye", "leftEar", "rightEar", "leftShoulder", "rightShoulder", "leftElbow", "rightElbow", "leftWrist", "rightWrist", "leftHip", "rightHip", "leftKnee", "rightKnee", "leftAnkle", "rightAnkle"]
      ...
      , v = [["leftHip", "leftShoulder"], ["leftElbow", "leftShoulder"], ["leftElbow", "leftWrist"], ["leftHip", "leftKnee"], ["leftKnee", "leftAnkle"], ["rightHip", "rightShoulder"], ["rightElbow", "rightShoulder"], ["rightElbow", "rightWrist"], ["rightHip", "rightKnee"], ["rightKnee", "rightAnkle"], ["leftShoulder", "rightShoulder"], ["leftHip", "rightHip"]].map(function(t) {
        var e = t[0]
          , r = t[1];
        return [m[e], m[r]]
    });
    ...
    function N(t) {
        var r = t.shape
          ...
          , o = r[2];
        return e.tidy(function() {
            var r, u, s = t.reshape([n * i, o]).argMax(0), a = s.div(e.scalar(i, "int32")).expandDims(1), l = (r = s,
            u = i,
            e.tidy(function() {
        ...
        return u(this, void 0, void 0, function() {
            ...
            return s(this, function(s) {
                ...
                case 0:
                    return n = 0,
                    i = N(t),
                    [4, Promise.all([t.buffer(), e.buffer(), i.buffer()])];
                case 1:
                    return o = s.sent(),
                    u = o[0],
                    a = o[1],
...
//       , F = "https://storage.googleapis.com/tfjs-models/savedmodel/posenet/resnet50/";
    ...
    var T = [-123.15, -115.9, -103.06]
      , V = function(t) {
        ...
        return i(e, t),
        e.prototype.preprocessInput = function(t) {
            return t.add(T)
        }
        ,
    ...
    function W(t, e) {
        return D(t),
        "object" == typeof t ? [z(t.height, e), z(t.width, e)] : [z(t, e), z(t, e)]
    }
    var C = [8, 16, 32];
    function G(t, e) {
        return (t - 1) % e == 0
    ...
    function J(t, r) {
        ...
        return s / u < a ? (f = 0,
        c = 0,
        p = Math.round(.5 * (a * u - s)),
        h = Math.round(.5 * (a * u - s))) : (f = Math.round(.5 * (1 / a * s - u)),
        c = Math.round(.5 * (1 / a * s - u)),
        p = 0,
        h = 0),
        {
    ...
    function L(t, e, r, n, i) {
        var o = e[0]
          ...
          , l = function(t, e, r, n, i) {
            return void 0 === n && (n = 0),
            void 0 === i && (i = 0),
            1 === r && 1 === e && 0 === n && 0 === i ? t : t.map(function(t) {
                return X(t, e, r, n, i)
            })
            ...
            u(this, void 0, void 0, function() {
                ...
                return s(this, function(k) {
                    ...
                    case 0:
                        ...
                        function(t) {
                            var e = t.maxDetections
                              ...
                              , n = t.nmsRadius;
                            if (e <= 0)
                                throw new Error("Invalid maxDetections " + e + ". Should be > 0");
                            if (r < 0 || r > 1)
                    ...
                    case 1:
                        ...
                        _ = b[2],
                        S = b[3],
                        [4, P(w, x, _, S, n, r.maxDetections, r.scoreThreshold, r.nmsRadius)];
                    case 2:
                        return E = k.sent(),
                        M = L(E, [l, f], i, h, r.flipHorizontal),
                        m.dispose(),
                        y.dispose(),
                        v.dispose(),
                        g.dispose(),
        ...
        t.prototype.estimateSinglePose = function(t, e) {
            ...
            u(this, void 0, void 0, function() {
                ...
                return s(this, function(s) {
                    ...
                    case 1:
                        return g = s.sent(),
                        b = L([g], [a, l], i, p, r.flipHorizontal),
                        d.dispose(),
                        m.dispose(),
                        y.dispose(),
                        v.dispose(),
        ...
        return u(this, void 0, void 0, function() {
            ...
            return s(this, function(s) {
                ...
                case 0:
                    ...
                    [4, r.loadGraphModel(t.modelUrl || u)];
                case 1:
                    return a = s.sent(),
                    f = new l(a,n),
                    c = W(t.inputResolution, f.outputStride),
                    [2, new ot(f,c)]
                }
            })
        })
        ...
        return u(this, void 0, void 0, function() {
            ...
            return s(this, function(s) {
                ...
                case 1:
                    return u = s.sent(),
                    a = new V(u,n),
                    l = W(t.inputResolution, a.outputStride),
                    [2, new ot(a,l)]
                }
            })
        })
    }
    t.decodeMultiplePoses = P,
    t.decodeSinglePose = A,
    t.MobileNet = l,
    t.partChannels = ["left_face", "right_face", "right_upper_leg_front", "right_lower_leg_back", "right_upper_leg_back", "left_lower_leg_front", "left_upper_leg_front", "left_upper_leg_back", "left_lower_leg_back", "right_feet", "right_lower_leg_front", "left_feet", "torso_front", "torso_back", "right_upper_arm_front", "right_upper_arm_back", "right_lower_arm_back", "left_lower_arm_front", "left_upper_arm_front", "left_upper_arm_back", "left_lower_arm_back", "right_hand", "right_lower_arm_front", "left_hand"],
    t.partIds = m,
    t.partNames = h,
    t.poseChain = y,
    t.load = function(t) {
        ...
        u(this, void 0, void 0, function() {
            return s(this, function(e) {
                return "ResNet50" === (t = function(t) {
                    if (null == (t = t || Z).architecture && (t.architecture = "MobileNetV1"),
                    $.indexOf(t.architecture) < 0)
                        throw new Error("Invalid architecture " + t.architecture + ". Should be one of " + $);
                    if (null == t.inputResolution && (t.inputResolution = 257),
                    D(t.inputResolution),
                    null == t.outputStride && (t.outputStride = 16),
                    tt[t.architecture].indexOf(t.outputStride) < 0)
                        throw new Error("Invalid outputStride " + t.outputStride + ". Should be one of " + tt[t.architecture] + " for architecutre " + t.architecture + ".");
                    if (null == t.multiplier && (t.multiplier = 1),
                    et[t.architecture].indexOf(t.multiplier) < 0)
                        throw new Error("Invalid multiplier " + t.multiplier + ". Should be one of " + et[t.architecture] + " for architecutre " + t.architecture + ".");
                    if (null == t.quantBytes && (t.quantBytes = 4),
                    rt.indexOf(t.quantBytes) < 0)
                        throw new Error("Invalid quantBytes " + t.quantBytes + ". Should be one of " + rt + " for architecutre " + t.architecture + ".");
                    return t
    ...
    t.getAdjacentKeyPoints = function(t, e) {
        return v.reduce(function(r, n) {
            ...
            return function(t, e, r) {
                return t < r || e < r
            }(t[i].score, t[o].score, e) ? r : (r.push([t[i], t[o]]),
            r)
        }, [])
    }
    ,
